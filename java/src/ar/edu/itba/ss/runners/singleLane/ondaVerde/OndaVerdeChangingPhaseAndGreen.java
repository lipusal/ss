...
public class OndaVerdeChangingPhaseAndGreen extends Runner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String experimentFolder = "changing_green_and_phase";
        String experimentName;

        File outputFile = Paths.get("ondaVerde", experimentFolder, "_" + experimentFolder + "_results.csv").toFile(),
        ...
        int  RED_DURATION_FINAL = RED_DURATION;
        for (int green_delta = 0; green_delta < 100; green_delta++) {
            int GREEN_DURATION_FINAL = GREEN_DURATION + green_delta;
            for (int phase_delta = 0; phase_delta < GREEN_DURATION_FINAL; phase_delta++) {
                int PHASE_BETWEEN_LIGHTS_FINAL = PHASE_BETWEEN_LIGHTS + phase_delta;
