...
public class OndaVerdeManual extends Runner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final int GREEN_DURATION = 15,
                RED_DURATION = 25,
                PHASE_BETWEEN_LIGHTS = 18;
        ...
        do {
            ...
            int t = 0;
            try {
                ovitoWriter = new OvitoWriter<>(Paths.get("ondaVerde", "manual.txt"));
                ...
                for (int x = 54; x < ROAD_LENGTH; x += 54) { // 54 * 7.5 = 405m
                    ...
                    phase += PHASE_BETWEEN_LIGHTS; // The phase varies between lights
                }
                ...
                while (timeMap.containsValue(-1)) {
                    ...
                    t++;
                    if (t > 500) {
                        System.err.println("Simulation not completed after 500 seconds, terminating run");
                        break;
                    }
                }
                System.out.println("Run completed at t=" + t);
                errored = false;
                ...
                if (ovitoWriter != null) {
                    ovitoWriter.close();
                    Files.copy(Paths.get("ondaVerde", "manual.txt"), Paths.get("in.txt"), StandardCopyOption.REPLACE_EXISTING);
                }
            }
        } while (errored);
    }
